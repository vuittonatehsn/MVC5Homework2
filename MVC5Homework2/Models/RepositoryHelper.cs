namespace MVC5Homework2.Models
{
	public static class RepositoryHelper
	{
		...
		public static MemberViewRepository GetMemberViewRepository()
		{
			var repository = new MemberViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static MemberViewRepository GetMemberViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new MemberViewRepository();
